 ...
 * 2011-11-13T10:40:16.908+01:00
 * Generated source version: 2.4.3
 * 
 */
@WebServiceClient(name = "Registry_Service", 
                  wsdlLocation = "file:/M:/uni/workspace/aic_ue1/src/main/java/wsdl/registry_service.wsdl",
...
public class RegistryService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/M:/uni/workspace/aic_ue1/src/main/java/wsdl/registry_service.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(RegistryService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/M:/uni/workspace/aic_ue1/src/main/java/wsdl/registry_service.wsdl");
        }
        WSDL_LOCATION = url;
    }
